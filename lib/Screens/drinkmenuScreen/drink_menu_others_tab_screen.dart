...
class DrinkMenuOthersTabScreen extends StatefulWidget {
  const DrinkMenuOthersTabScreen({super.key});

  @override
  State<DrinkMenuOthersTabScreen> createState() =>
      _DrinkMenuOthersTabScreenState();
}

class _DrinkMenuOthersTabScreenState extends State<DrinkMenuOthersTabScreen> {
  @override
